...
Source0  : https://gstreamer.freedesktop.org/src/gstreamer-vaapi/gstreamer-vaapi-1.18.1.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/gstreamer-vaapi/gstreamer-vaapi-1.18.1.tar.xz.asc
...
%prep
%setup -q -n gstreamer-vaapi-1.18.1
cd %{_builddir}/gstreamer-vaapi-1.18.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603927926
...
cp %{_builddir}/gstreamer-vaapi-1.18.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/gstreamer-vaapi/01a6b4bf79aca9b556822601186afab86e8c4fbf
