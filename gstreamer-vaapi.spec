...
Version  : 1.24.8
Release  : 71
URL      : https://gstreamer.freedesktop.org/src/gstreamer-vaapi/gstreamer-vaapi-1.24.8.tar.xz
Source0  : https://gstreamer.freedesktop.org/src/gstreamer-vaapi/gstreamer-vaapi-1.24.8.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/gstreamer-vaapi/gstreamer-vaapi-1.24.8.tar.xz.asc
...
%setup -q -n gstreamer-vaapi-1.24.8
cd %{_builddir}/gstreamer-vaapi-1.24.8
pushd ..
cp -a gstreamer-vaapi-1.24.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726758349
