...
Source0  : https://gstreamer.freedesktop.org/src/gstreamer-vaapi/gstreamer-vaapi-1.24.0.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/gstreamer-vaapi/gstreamer-vaapi-1.24.0.tar.xz.asc
...
%prep
%setup -q -n gstreamer-vaapi-1.24.0
cd %{_builddir}/gstreamer-vaapi-1.24.0
pushd ..
cp -a gstreamer-vaapi-1.24.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709661179
