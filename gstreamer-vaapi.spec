...
Source0  : https://gstreamer.freedesktop.org/src/gstreamer-vaapi/gstreamer-vaapi-1.24.1.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/gstreamer-vaapi/gstreamer-vaapi-1.24.1.tar.xz.asc
...
%prep
%setup -q -n gstreamer-vaapi-1.24.1
cd %{_builddir}/gstreamer-vaapi-1.24.1
pushd ..
cp -a gstreamer-vaapi-1.24.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711237727
