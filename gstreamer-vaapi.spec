...
Source0  : https://gstreamer.freedesktop.org/src/gstreamer-vaapi/gstreamer-vaapi-1.22.2.tar.xz
Source1  : https://gstreamer.freedesktop.org/src/gstreamer-vaapi/gstreamer-vaapi-1.22.2.tar.xz.asc
...
%prep
%setup -q -n gstreamer-vaapi-1.22.2
cd %{_builddir}/gstreamer-vaapi-1.22.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681312114
