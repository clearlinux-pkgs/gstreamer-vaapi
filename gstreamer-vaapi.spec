...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580510610
...
CFLAGS="$CFLAGS" CXXFLAGS="$CXXFLAGS" LDFLAGS="$LDFLAGS" meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dgtk_doc=enabled  builddir
ninja -v -C builddir
