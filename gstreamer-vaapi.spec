...
%prep
%setup -q -n gstreamer-vaapi-1.20.1
cd %{_builddir}/gstreamer-vaapi-1.20.1
...
cp %{_builddir}/gstreamer-vaapi-1.20.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/gstreamer-vaapi/01a6b4bf79aca9b556822601186afab86e8c4fbf
